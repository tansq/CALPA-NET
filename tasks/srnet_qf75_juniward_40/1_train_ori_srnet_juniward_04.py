...
# @Author  : WeiLong Wu
# @File    : 1_train_ori_srnet_juniward_04.py
# @Function: Using juniward 0.4bpnzac to train the original SRNet
...
# Cover and Stego directories for training,validation and test. For the spatial domain put cover and stego images in their
...
LOG_DIR = train_ori_srnet_log_path
