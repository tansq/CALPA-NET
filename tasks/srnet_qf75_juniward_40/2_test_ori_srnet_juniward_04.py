...
# @Author  : WeiLong Wu
# @File    : 2_test_ori_srnet_juniward_04.py
# @Function: Using juniward 0.4bpnzac to test the original SRNet
...
LOAD_CKPT = test_ori_srnet_path + 'Model_xxx.ckpt'  # loading from a specific checkpoint
