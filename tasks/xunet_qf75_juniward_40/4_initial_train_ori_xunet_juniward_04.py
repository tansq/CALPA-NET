...
# @Author  : wuwl
# @File    : 4_initial_train_ori_xunet_juniward_04.py
# @Function: Using juniward 0.4bpnzac to re-initial and train the pruned XuNet

from XuNet2_qf75_juniward_04_pruned_Ta05 import *
...
LOG_DIR = initial_train_ori_xunet_log_path_pruned_05
...
xunet_train(XuNet2_pruned, train_gen, valid_gen, train_batch_size, valid_batch_size, valid_ds_size,
